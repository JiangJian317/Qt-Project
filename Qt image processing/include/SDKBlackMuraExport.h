#ifndef SDK_BLACKMURA_EXPORT_H
#define SDK_BLACKMURA_EXPORT_H
...
#if defined(MAKE_SDKBLACKMURA)
#  define SDKBLACKMURA_EXPORT Q_DECL_EXPORT
#  define SDKBLACKMURA_IMPORT extern
#else
#  define SDKBLACKMURA_EXPORT Q_DECL_IMPORT
#  define SDKBLACKMURA_IMPORT Q_DECL_IMPORT
#endif
